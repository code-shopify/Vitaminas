        ...
        (T4SThemeSP.Tooltip = (function () {
            ...
            (T4SThemeSP.ProductAjax = (function () {
                var t = { loading: "is--loading" },
                    ...
                    a = i ? "cart_data" : `cart_data,mini_cart,${window.QuickOrderListID}`,
                    s = "cart" != g ? ("product" == g ? a : o) : `cart_data,${window.cartT4SectionID}`,
                ...
                function S(e, t, n) {
                    ...
                    o.addClass("is--contentUpdate"),
                        ...
                        r.on("cart:updated", function (e) {
                            o.removeClass("is--contentUpdate"), r.off("cart:updated"), i.removeClass("is--update"), a.attr("hidden", ""), l.attr("hidden", "");
                        });
                    const c = T("javascript");
                    (c.headers["X-Requested-With"] = "XMLHttpRequest"),
                        (c.body = JSON.stringify({ line: i.index() + 1, quantity: n, sections: s, sections_url: window.location.pathname })),
                        fetch(`${p}`, c)
                            .then((e) => e.json())
                            .then((e) => {
                                if (e.status) return y(e.description), void r.trigger("cart:updated", ["error"]);
                                b(e.sections);
                            })
                            .catch((e) => {
                ...
                function x(i) {
                    ...
                    i.on("click", "[data-atc-form]", function (m) {
                        if (e(this).attr(n.disabled)) m.preventDefault(), T4SThemeSP.Notices(T4SProductStrings.pleaseChooseOptions);
                        else {
                            if (
                                (s &&
                                    (m.preventDefault(),
                                    ...
                                    a.each(function () {
                                        ...
                                        n.hasClass("is--type-radio") || n.hasClass("is--type-checkbox") ? n.find("input[name]").is(":checked") || (n.addClass(v), (c = !0)) : 0 == t.val().length && (n.addClass(v), (c = !0));
                                    })),
                                c)
                            )
                                return (
                                    ...
                                    void a.off(h).on(h, function (t) {
                                        ...
                                        i.hasClass("is--type-radio") || i.hasClass("is--type-checkbox") ? i.find("input[name]").is(":checked") && i.removeClass(v) : n.val().length > 0 && i.removeClass(v);
                                    })
                                );
                            if (!l) return;
                            a.off(h),
                                                ...
                                                if (T4SThemeSP.isEditCartReplace && e.variant_id != T4SThemeSP.iDVariantEdit) {
                                                    ...
                                                    (e.headers["X-Requested-With"] = "XMLHttpRequest"),
                                                        ...
                                                        fetch(`${p}`, e)
                                                            .then((e) => e.json())
                                                            .then((e) => {
                                                                e.status ? y(e.description) : (r.trigger("add:cart:success").trigger("add:cart:upsell"), (T4SThemeSP.isATCSuccess = !0), b(e.sections));
                                                            })
                                                            .catch((e) => {
                                                                console.error(e);
                                                            });
                                                } else r.trigger("add:cart:success").trigger("add:cart:upsell"), (T4SThemeSP.isATCSuccess = !0), b(e.sections);
                                                   var cashRegisterSound = new Audio("https://cdn.shopify.com/s/files/1/0923/8521/4763/files/caja-registradora.mp3");
                        ...
                        l &&
                            ...
                            (function (e) {
                                ...
                                var o = e.attr("data-variant-id"),
                                    a = parseInt(e.prev("[data-quantity-wrapper]").find("[data-quantity-value]").val()) || e.data("qty") || 1,
                                    l = [];
                                l.push({ id: o, quantity: a }),
                                    (i.body = JSON.stringify({ items: l, sections: s, sections_url: window.location.pathname })),
                                    ...
                                    fetch(`${u}`, i)
                                        ...
                                        .then((e) => {
                                            if (e.status) return y(e.description), void r.trigger("cart:updated", ["error"]);
                                            r.trigger("add:cart:success").trigger("add:cart:upsell"), (T4SThemeSP.isATCSuccess = !0), b(e.sections);
                                        })
                                        .catch((e) => {
                                            r.trigger("cart:updated"), console.error(e);
                                        });
            ...
            (T4SThemeSP.Cart = (function () {
                ...
                function R(l, f = !1) {
                    var h = l.cart_data,
                        ...
                        A = k.find(a),
                        M = e(s);
                    if ((0 != (h = (h = h.split("[t4s_split1]")[1]).split("[t4s_split2]"))[0] && !T4SThemeSP.isATCSuccess) || "cart" != g) {
                        ...
                        e("[data-cart-count]").html(E),
                            e("[data-cart-ttcount]").html(E < 2 ? p.item_cart[E] : p.item_cart[2]),
                            e("[data-cart-tt-price]").html(h[1]),
                            "1" == h[2] ? (e(".t4s-mini_cart-tool__content.is--gift.is--opend [data-cart-tool_close]").trigger("click"), e("[data-toogle-gift]").hide()) : e("[data-toogle-gift]").show(),
                            0 == h[0] ? c.addClass("t4s-cart-count-0") : (c.removeClass("t4s-cart-count-0"), I && (W(), (I = !1))),
                            document.dispatchEvent(new CustomEvent("cart:update:count", { detail: { count: h[0] }, bubbles: !0, cancelable: !0 })),
                            T4SThemeSP.Tooltip(),
                            d.trigger("currency:update"),
                            "0" != S && T4SThemeSP.isATCSuccess && O(),
                            document.dispatchEvent(new CustomEvent("cart:updated", { detail: { count: h[0] }, bubbles: !0, cancelable: !0 })),
                            r.trigger("cart:updated"),
                            H();
                    } else O();
                }
                function O() {
                    (T4SThemeSP.isATCSuccess = !1),
                        "1" == S ||
                            "2" == S ||
                            ("3" == S ? (T4SThemeSP.cartTabActive || e("[data-is-tab-cart]").trigger("click"), T4SThemeSP.Drawer.opend(e("#t4s-mini_cart"))) : (document.location.href = "5" == S ? T4SThemeSP.root_url + "checkout" : A));
                }
                function N(t) {
                    var n,
                ...
                function B(t) {
                    ...
                    s.addClass(b.loading),
                        ...
                        fetch(A + "/shipping_rates.json?" + e.param({ shipping_address: a }), { credentials: "same-origin", method: "GET" }).then(function (t) {
                ...
                function H() {
                    ...
                    t > 0 && f ? (T4SThemeSP.CanvasConfetti(), (f = !1), (h = !1)) : e(i).length > 0 && h ? (T4SThemeSP.CanvasConfetti(), (h = !1)) : 0 == t && ((h = !1), (f = !0));
                }
                function W() {
                    let t = e(`[${l}]`);
                    if (0 == t.length) return;
                    let n = _(t.attr(l));
                    if (((n.product_id = e("[data-cart-items] [data-cart-item]:first").data("pid") || n.product_id || 19041994), k == n.product_id)) return;
                    k = n.product_id;
                ...
                return {
                    ...
                    init: function () {
                        !(function () {
                            if ("cart" == g) return $(), F(), L(), U(), T4SThemeSP.agreeForm(), H(), void W();
                            IsDesignMode
                                ? M()
                                : T ||
